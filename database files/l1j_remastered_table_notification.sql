...
(1, 'NORMAL(0)', 'false', 'true', '$1506', '에르자베', 'Ant Queen', 'BOSS(2)', 5136, NULL, NULL, '4, 32892, 33225', 300, 'false', 'NO_ANIMATION(0)'),
(2, 'NORMAL(0)', 'true', 'true', '$11993', '샌드 웜', 'Sand Worm', 'BOSS(2)', 5135, NULL, NULL, '4, 32732, 33141', 300, 'false', 'NO_ANIMATION(0)'),
(3, 'NORMAL(0)', 'false', 'false', '$14740', '붉은 기사단의 진격', 'Red Knight\'s Adance', 'NONE(0)', 0, NULL, NULL, '4, 32595, 33167', 0, 'false', 'NO_ANIMATION(0)'),
(4, 'NORMAL(0)', 'false', 'false', '$42714', '고대 물품 상인', 'Ancient Merchant', 'NONE(0)', 0, NULL, NULL, '4, 32620, 32789', 0, 'false', 'NO_ANIMATION(0)'),
(5, 'NORMAL(0)', 'true', 'false', '$23228', '잊혀진 섬', 'Forgotten Island', 'FORGOTTEN(6)', 0, NULL, NULL, '4, 33431, 33499', 0, 'false', 'NO_ANIMATION(0)'),
(16, 'NORMAL(0)', 'true', 'false', '$29760', '지배의 탑', 'Domination Tower', 'DOMINATION_TOWER(3)', 0, NULL, NULL, '4, 33930, 33348', 0, 'false', 'NO_ANIMATION(0)'),
...
(21, 'NORMAL(0)', 'false', 'false', '$31212', '비밀 상인', 'Secret Merchant', 'NONE(0)', 0, NULL, NULL, NULL, 0, 'false', 'NO_ANIMATION(0)'),
(22, 'NORMAL(0)', 'false', 'false', '$31946', '격전의 콜로세움', 'Colosseum Battle', 'COLOSSEUM(4)', 0, NULL, NULL, '4, 33498, 32768', 200, 'false', 'NO_ANIMATION(0)'),
(23, 'CHANGE(1)', 'true', 'false', '$32010', '여왕개미의 은신처', 'Ant Queen\'s Nest', 'NONE(0)', 0, NULL, NULL, '4, 32854, 33267', 0, 'false', 'ANT_QUEEN(1)'),
(24, 'NORMAL(0)', 'false', 'false', '$13911', '숨겨진 사냥터', 'Hidden Areas', 'CUSTOM(1)', 0, '2022-09-25 06:00:00', '2022-09-30 06:00:00', NULL, 0, 'true', 'NO_ANIMATION(0)'),
(25, 'NORMAL(0)', 'false', 'false', '$42718', '혈맹 상점', 'Clan shop', 'NONE(0)', 0, NULL, NULL, NULL, 0, 'false', 'NO_ANIMATION(0)'),
(26, 'CHANGE(1)', 'true', 'false', '$33543', '균열의 오만의 탑', 'Rift on TOI %dF', 'NONE(0)', 0, NULL, NULL, '4, 33930, 33348', 0, 'false', 'OMAN_MORPH(2)'),
(30, 'NORMAL(0)', 'true', 'false', '$36722', '만월의 보물섬', 'Treasure Island', 'TREASURE(5)', 0, NULL, NULL, '4, 33614, 33247', 300, 'false', 'NO_ANIMATION(0)'),
(33, 'CHANGE(1)', 'true', 'false', '$35454', '하이네 점령전', 'Heine Conquest', 'NONE(0)', 0, NULL, NULL, '4, 33431, 33500', 0, 'false', 'NO_ANIMATION(0)'),
(35, 'CHANGE(1)', 'true', 'false', '$36529', '윈다우드 점령전', 'Windawood Conquest', 'NONE(0)', 0, NULL, NULL, '4, 32585, 33438', 0, 'false', 'NO_ANIMATION(0)'),
(100, 'CHANGE(1)', 'true', 'false', '$36108', '거울 전쟁', 'Mirror War', 'NONE(0)', 0, NULL, NULL, '4, 33430, 32825', 0, 'false', 'AI_BATTLE(3)'),
